...
SSH into your TrueNAS SCALE system and place the scripts in a directory of your choice, for example:
...
### 3. Add the scripts in the TrueNAS web UI
...
Type: 		Script
Script: 	full path to wdpreinit-v2.sh (ie /root/wd-pr4100/wdpreinit-v2.sh)
When: 		Pre Init
Enabled: 	Yes
Timeout:	10
...
Type: 		Script
Script: 	full path to wdpostinit-v2.sh (ie /root/wd-pr4100/wdpostinit-v2.sh)
When: 		Post Init
Enabled: 	Yes
Timeout:	10
...
Type: 		Script
Script: 	full path to wdshutdown-v2.sh (ie /root/wd-pr4100/wdpostinit-v2.sh)
When: 		Shutdown
Enabled: 	Yes
...
@stefaang
the original PMC / front panel control work from the WD PR4100 FreeNAS community
other WD PR-series hardware control projects and reverse-engineering efforts
